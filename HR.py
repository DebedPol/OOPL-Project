...
class employee_info_form():
    def frames(self, x, y):
        self.frame1 = Frame(window, width=1100, height=160, border=0, bg='#ffcccb')
    ...
    def label_design(self, x, y, text_value):
        ...
        self.lbl = Label(text=text_value, fg='dark violet', bg='#ffcccb', font=('Arial', 10, 'bold'))
        self.lbl.place(x=x, y=y)

    def label_design2(self, x, y, text_value):
        self.text_value = text_value
        self.lbl = Label(text=text_value, fg='dark violet', font=('Arial', 30, 'bold'))
        self.lbl.place(x=x, y=y)

    def button_design(self, x, y, text, command):
        self.button = Button(width=15, pady=7, text=text, bg='#ff6347', fg='#4169E1', cursor='hand2',
